...
if __name__ == "__main__":
    ...
    H5_PATH   = "/data/HydroTransformer/daymet/watershed_timeseries.h5"
    ...
    val_ws   = [4113000, 4144500, 4097500, 4146000, 4104945]  # e.g., ['04142000', ...]
    ...
    mm_clim = "uplog10__CLIMATE__TRAIN_GLOBAL.json"
    mm_flow = "uplog10__FLOW__TRAIN_GLOBAL.json"
    mm_stat = "uplog10__STATIC__TRAIN_GLOBAL.json"
